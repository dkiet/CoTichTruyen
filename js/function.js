...
function onPageClick(e) {
	...
	window.location.href = "main.html?" + targetEl.cate + "#page=" + targetEl.number;
	location.reload();
}
...
function gotoCoTichVietNam() {
	window.location.href = "main.html?co-tich-viet-nam#page=1";
}

function gotoCoTichVeLoaiVat() {
	window.location.href = "main.html?co-tich-ve-loai-vat#page=1";
}

function gotoCoTichThanKy() {
	window.location.href = "main.html?co-tich-than-ky#page=1";
}

function gotoCoTichTheTuc() {
	window.location.href = "main.html?co-tich-the-tuc#page=1";
}

function gotoCoTichTheGioi() {
	window.location.href = "main.html?co-tich-the-gioi#page=1";
}

function gotoTruyenCuoi() {
	window.location.href = "main.html?truyen-cuoi#page=1";
}

function gotoTruyenNguNgon() {
	window.location.href = "main.html?truyen-ngu-ngon#page=1";
}

function gotoTruyenDanGian() {
	window.location.href = "main.html?truyen-dan-gian#page=1";
}

function gotoTruyenCoGrimm() {
	window.location.href = "main.html?truyen-co-grimm#page=1";
}

function gotoTruyenCoAndersen() {
	window.location.href = "main.html?truyen-co-andersen#page=1";
}

function gotoThanThoaiHyLap() {
	window.location.href = "main.html?than-thoai-hy-lap#page=1";
}
